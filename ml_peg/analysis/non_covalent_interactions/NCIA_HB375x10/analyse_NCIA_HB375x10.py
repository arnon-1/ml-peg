"""Analyse NCIA HB375x10 benchmark."""
...
OUT_PATH = APP_ROOT / "data" / "non_covalent_interactions" / "NCIA_HB375x10"
...
@pytest.fixture
@plot_density_scatter(
    filename=OUT_PATH / "figure_ncia_hb375x10_density.json",
