"""Analyse NCIA IHB100x10 benchmark."""
...
OUT_PATH = APP_ROOT / "data" / "non_covalent_interactions" / "NCIA_IHB100x10"
...
@pytest.fixture
@plot_density_scatter(
    filename=OUT_PATH / "figure_ncia_ihb100x10_density.json",
